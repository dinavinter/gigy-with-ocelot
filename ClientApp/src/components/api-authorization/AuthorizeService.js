...
import { ApplicationPaths, ApplicationName, GigyaOidcClient } from './ApiAuthorizationConstants';
...
export class AuthorizeService {
    ...
    getClientSettings(){
        return {
            ...
            popup_redirect_uri:"https://localhost:7001/authentication/login-callback",
            post_logout_redirect_uri: "https://localhost:7001/authentication/logout-callback",
            response_type: "code",
